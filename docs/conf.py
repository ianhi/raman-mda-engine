...
try:
    from raman_mda_engine import __version__ as release
except ImportError:
    release = "unknown"
...
html_theme_options = {
    ...
    "repository_url": "https://github.com/ianhi/raman-mda-engine",
    "use_download_button": True,
    "use_edit_page_button": True,
    "use_issues_button": True,
    "use_repository_button": True,
}
html_title = "raman-mda-engine"
